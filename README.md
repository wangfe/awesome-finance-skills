...
|---|---|---|
| [50/30/20 Budget Builder](skills/personal-finance/budgeting/50-30-20-budget-builder.md) | Build a personalized monthly budget and get rebalancing suggestions | `budgeting` `beginner` |
...
| Skill | Description | Tags |
|---|---|---|
| [Earnings Call Analyzer](skills/data-and-research/earnings-analysis/earnings-call-analyzer.md) | Extract key metrics, guidance, sentiment, and risks from an earnings transcript | `earnings` `transcript-analysis` `sentiment` `guidance` |
...
4. Submit a PR — fill in the PR template and quality checklist
...
*Built with by the open finance community. Star the repo if it helps you!*
